...
| Cargo | anyhow | 1.0.103 | MIT OR Apache-2.0 |
| Cargo | arbitrary | 1.4.2 | MIT OR Apache-2.0 |
| Cargo | arboard | 3.6.1 | MIT OR Apache-2.0 |
| Cargo | async-trait | 0.1.89 | MIT OR Apache-2.0 |
...
| Cargo | bytemuck | 1.25.1 | Zlib OR Apache-2.0 OR MIT |
...
| Cargo | cc | 1.2.67 | MIT OR Apache-2.0 |
...
| Cargo | crossbeam-queue | 0.3.13 | MIT OR Apache-2.0 |
...
| Cargo | crypto-primes | 0.7.2 | Apache-2.0 OR MIT |
...
| Cargo | der | 0.8.1 | Apache-2.0 OR MIT |
...
| Cargo | fastrand | 2.4.1 | Apache-2.0 OR MIT |
| Cargo | fax | 0.2.7 | MIT |
...
| Cargo | futures-intrusive | 0.5.0 | MIT OR Apache-2.0 |
...
| Cargo | hashlink | 0.11.1 | MIT OR Apache-2.0 |
...
| Cargo | num-integer | 0.1.46 | MIT OR Apache-2.0 |
...
| Cargo | pastey | 0.2.3 | MIT OR Apache-2.0 |
...
| Cargo | pkcs1 | 0.8.0-rc.4 | Apache-2.0 OR MIT |
...
| Cargo | quick-xml | 0.39.4 | MIT |
| Cargo | quick-xml | 0.41.0 | MIT |
| Cargo | quote | 1.0.46 | MIT OR Apache-2.0 |
...
| Cargo | ref-cast-impl | 1.0.25 | MIT OR Apache-2.0 |
| Cargo | ref-cast | 1.0.25 | MIT OR Apache-2.0 |
| Cargo | regex-automata | 0.4.15 | MIT OR Apache-2.0 |
| Cargo | regex-syntax | 0.8.11 | MIT OR Apache-2.0 |
| Cargo | regex | 1.13.0 | MIT OR Apache-2.0 |
| Cargo | reqwest | 0.13.4 | MIT OR Apache-2.0 |
| Cargo | rfd | 0.16.0 | MIT |
| Cargo | ring | 0.17.14 | Apache-2.0 AND ISC |
| Cargo | rmcp-macros | 2.2.0 | Apache-2.0 |
| Cargo | rmcp | 2.2.0 | Apache-2.0 |
| Cargo | rsa | 0.10.0-rc.18 | MIT OR Apache-2.0 |
...
| Cargo | serde_json | 1.0.150 | MIT OR Apache-2.0 |
| Cargo | serde_path_to_error | 0.1.20 | MIT OR Apache-2.0 |
| Cargo | serde_repr | 0.1.20 | MIT OR Apache-2.0 |
...
| Cargo | socket2 | 0.6.4 | MIT OR Apache-2.0 |
...
| Cargo | sqlx-core | 0.9.0 | MIT OR Apache-2.0 |
...
| Cargo | syn | 2.0.118 | MIT OR Apache-2.0 |
...
| Cargo | tauri-plugin-process | 2.3.1 | Apache-2.0 OR MIT |
...
| Cargo | termcolor | 1.4.1 | Unlicense OR MIT |
| Cargo | thiserror-impl | 1.0.69 | MIT OR Apache-2.0 |
| Cargo | thiserror-impl | 2.0.18 | MIT OR Apache-2.0 |
| Cargo | thiserror | 1.0.69 | MIT OR Apache-2.0 |
| Cargo | thiserror | 2.0.18 | MIT OR Apache-2.0 |
| Cargo | tiff | 0.11.3 | MIT |
| Cargo | time-core | 0.1.9 | MIT OR Apache-2.0 |
| Cargo | time-macros | 0.2.31 | MIT OR Apache-2.0 |
| Cargo | time | 0.3.53 | MIT OR Apache-2.0 |
...
| Cargo | toml_writer | 1.1.1+spec-1.1.0 | MIT OR Apache-2.0 |
| Cargo | toml | 0.8.2 | MIT OR Apache-2.0 |
| Cargo | toml | 0.9.12+spec-1.1.0 | MIT OR Apache-2.0 |
| Cargo | toml | 1.1.2+spec-1.1.0 | MIT OR Apache-2.0 |
...
| Cargo | uuid | 1.23.4 | Apache-2.0 OR MIT |
...
| Cargo | wayland-backend | 0.3.15 | MIT |
| Cargo | wayland-client | 0.31.14 | MIT |
| Cargo | wayland-protocols-wlr | 0.3.12 | MIT |
| Cargo | wayland-protocols | 0.32.13 | MIT |
| Cargo | wayland-scanner | 0.31.10 | MIT |
...
| Cargo | zstd-safe | 7.2.4 | MIT OR Apache-2.0 |
| Cargo | zstd-sys | 2.0.16+zstd.1.5.7 | MIT/Apache-2.0 |
| Cargo | zstd | 0.13.3 | MIT |
| Cargo | zune-core | 0.5.1 | MIT OR Apache-2.0 OR Zlib |
| Cargo | zune-jpeg | 0.5.15 | MIT OR Apache-2.0 OR Zlib |
| npm | @monaco-editor/loader | 1.7.0 | MIT |
| npm | @monaco-editor/react | 4.7.0 | MIT |
| npm | @tanstack/react-virtual | 3.14.5 | MIT |
| npm | @tanstack/virtual-core | 3.17.3 | MIT |
| npm | @tauri-apps/api | 2.11.1 | Apache-2.0 OR MIT |
| npm | @tauri-apps/plugin-clipboard-manager | 2.3.2 | MIT OR Apache-2.0 |
